...
(function(){
  var child_process, getAllEntries, ref$, map, sortBy, sortWith, reverse, markdown, deltosHome, readConfig, isIn, tagged, getFilename, getSlug, philtre, width, exec, fs, blocks, getChildEntries, buildListPage, buildImageListPage, toDatedMarkdownLink, toMarkdownLink, toImageBlock, sortOrderThenDate, buildHierarchicalList, embedWrapper, deltosLinkToHtml, processBlock, renderBlock, out$ = typeof exports != 'undefined' && exports || this;
  ...
  blocks.archive = function(block, entry){
    ...
    return buildListPage(entries, toDatedMarkdownLink).join("\n");
  };
  ...
  toDatedMarkdownLink = function(it){
    ...
    return "- " + day + " - [" + it.title + "](/by-id/" + it.id + "#" + getSlug(it) + ")";
  };
  toMarkdownLink = function(it){
    return "- [" + it.title + "](/by-id/" + it.id + "#" + getSlug(it) + ")";
  };
