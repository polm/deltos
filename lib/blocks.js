...
(function(){
  var child_process, getAllEntries, ref$, map, sortBy, sortWith, reverse, markdown, deltosHome, readConfig, isIn, tagged, getFilename, getSlug, getUrl, philtre, width, exec, fs, blocks, getChildEntries, buildListPage, buildImageListPage, toDatedMarkdownLink, toMarkdownLink, toImageBlock, sortOrderThenDate, buildHierarchicalList, embedWrapper, deltosLinkToHtml, processBlock, renderBlock, out$ = typeof exports != 'undefined' && exports || this;
  ...
  ref$ = require('./util'), markdown = ref$.markdown, deltosHome = ref$.deltosHome, readConfig = ref$.readConfig, isIn = ref$.isIn, tagged = ref$.tagged, getFilename = ref$.getFilename, getSlug = ref$.getSlug, getUrl = ref$.getUrl;
