...
(function(){
  var child_process, Markdown, markdown, getAllEntries, ref$, map, sortBy, sortWith, reverse, deltosHome, readConfig, isIn, tagged, getFilename, getSlug, width, exec, fs, blocks, getChildEntries, buildListPage, buildImageListPage, toMarkdownLink, toImageBlock, sortOrderThenDate, buildHierarchicalList, deltosLinkToHtml, processBlock, renderBlock, out$ = typeof exports != 'undefined' && exports || this;
  ...
  ref$ = require('./util'), deltosHome = ref$.deltosHome, readConfig = ref$.readConfig, isIn = ref$.isIn, tagged = ref$.tagged, getFilename = ref$.getFilename, getSlug = ref$.getSlug;
  width = readConfig().width || 500;
  exec = require('child_process').execSync;
  fs = require('fs-extra');
  blocks = {};
  blocks.img = function(block, entry){
    var words, imgSrc, srcFile, fname, ref$, ftype, thumbroot, tag, caption, croppedHeader;
    words = block.split(' ');
    words.shift();
