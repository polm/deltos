...
(function(){
  var child_process, Markdown, markdown, getAllEntries, ref$, map, sortBy, sortWith, reverse, isIn, tagged, getFilename, getSlug, fs, blocks, getChildEntries, buildListPage, toMarkdownLink, sortOrderThenDate, buildHierarchicalList, deltosLinkToHtml, processBlock, renderBlock, out$ = typeof exports != 'undefined' && exports || this;
  ...
  ref$ = require('./util'), isIn = ref$.isIn, tagged = ref$.tagged, getFilename = ref$.getFilename, getSlug = ref$.getSlug;
  fs = require('fs');
  blocks = {};
  ...
  blocks.recent = function(block, entry){
    entry.updated = true;
    return buildListPage().slice(0, 5).join("\n");
  };
