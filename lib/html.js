...
(function(){
  ...
  out$.dumpJson = dumpJson = function(){
    var entries, out, i$, len$, entry, data;
    htmlInit();
    entries = reverse(
    sortBy(function(it){
      return it.date;
    ...
    for (i$ = 0, len$ = (ref$ = raw.split("\n")).length; i$ < len$; ++i$) {
      ...
      if (beginsWith('!', line)) {
        ...
        case 'video':
          ...
          break;
        case 'search':
          line = '<input class="deltos-search" type="text"></input> \n<div class="deltos-results"></div> \n<script src="/search.js"></script>';
          break;
        case 'archive':
