...
(function(){
  ...
  out$.buildSite = buildSite = function(priv){
    ...
    if (!priv) {
      return fs.writeFileSync(deltosHome + 'deltos.published.json', entriesToJson(entries));
    }
  };
