...
(function(){
  var fs, markdown, ref$, memoize, isIn, tagged, yaml, deltosHome, getAllEntries, map, take, sortBy, sortWith, reverse, ls, domino, RSS, eep, Section, render, buildPrivateReference, buildSite, allToJson, htmlInit, readConfig, buildPage, addMetaTags, setMeta, getRenderedEntries, beginsWith, readEntryBody, getChildEntries, getTemplate, searchableText, entryRules, deltosLinkToHtml, toMarkdownLink, buildListPage, sortOrderThenDate, buildHierarchicalList, getEntriesToBuild, buildSiteHtml, buildRss, out$ = typeof exports != 'undefined' && exports || this;
  fs = require('fs');
  ...
  out$.allToJson = allToJson = function(){
