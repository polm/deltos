...
(function(){
  var loadEntriesThen, makeHitDiv, makeEmbed, search, input;
  ...
  makeHitDiv = function(hit, query){
    var div;
    div = document.createElement('div');
    div.innerHTML = makeEmbed(hit);
    return div;
  };
  ...
  search = function(){
    ...
    for (i$ = 0, len$ = (ref$ = entries).length; i$ < len$; ++i$) {
      entry = ref$[i$];
      if (query.length === 0 || -1 < entry.body.indexOf(query)) {
