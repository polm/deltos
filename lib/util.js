...
(function(){
  ...
  out$.launchSearch = launchSearch = function(after){
    var searchUsingDefault, philtre, ref$, renderTsvEntry, newNote, getAllEntriesAsync, entryToString, addTostring, entries, editExisting, editNew, searchy;
    searchUsingDefault = require('searchy').searchUsingDefault;
    philtre = require('philtre').philtre;
    ref$ = require('./entries'), renderTsvEntry = ref$.renderTsvEntry, newNote = ref$.newNote, getAllEntriesAsync = ref$.getAllEntriesAsync;
  ...
  out$.getMtime = getMtime = function(fname){
    var e;
    try {
      return fs.statSync(fname).mtime.toISOString();
    } catch (e$) {
      e = e$;
      return 0;
    }
