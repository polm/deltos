...
(function(){
  ...
  out$.launchSearch = launchSearch = function(after){
    var searchUsingDefault, philtre, ref$, renderTsvEntry, newNote, getAllEntriesAsync, allEntriesCacheFirst, entryToString, addTostring, entries, editExisting, editNew, searchy;
    searchUsingDefault = require('searchy').searchUsingDefault;
    philtre = require('philtre').philtre;
    ref$ = require('./entries'), renderTsvEntry = ref$.renderTsvEntry, newNote = ref$.newNote, getAllEntriesAsync = ref$.getAllEntriesAsync, allEntriesCacheFirst = ref$.allEntriesCacheFirst;
