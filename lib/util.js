...
(function(){
  var deltosHome, BASEDIR, getFilename, CONFIG, fs, Yaml, yaml, yamlDump, memoize, isIn, tagged, noEmpty, getSlug, localIsoTime, getYesterday, readStdinAsLinesThen, launchEditor, launchSearch, readConfig, editConfig, installTheme, getMtime, out$ = typeof exports != 'undefined' && exports || this;
  ...
  out$.launchSearch = launchSearch = function(after){
    var searchUsingDefault, philtre, ref$, renderTsvEntry, newNote, getAllEntriesAsync, getAllMetadata, entryToString, addTostring, entries, editExisting, editNew, searchy;
    searchUsingDefault = require('searchy').searchUsingDefault;
    philtre = require('philtre').philtre;
    ref$ = require('./entries'), renderTsvEntry = ref$.renderTsvEntry, newNote = ref$.newNote, getAllEntriesAsync = ref$.getAllEntriesAsync, getAllMetadata = ref$.getAllMetadata;
    ...
    return getAllEntriesAsync(searchy.items, addTostring, searchy.refresh);
  };
