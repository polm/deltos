...
(function(){
  var deltosHome, BASEDIR, getFilename, CONFIG, fs, Yaml, yaml, yamlDump, Markdown, markdown, memoize, isIn, tagged, noEmpty, getSlug, localIsoTime, getYesterday, readStdinAsLinesThen, launchEditor, launchSearch, readConfig, editConfig, installTheme, getMtime, getUrl, out$ = typeof exports != 'undefined' && exports || this;
  ...
  out$.launchSearch = launchSearch = function(){
    ...
    return fzf.stdout.on('data', function(it){
      return launchEditor(getFilename(it.trim().split('\t')[2]));
    });
  };
