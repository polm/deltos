...
(function(){
  ...
  out$.launchSearch = launchSearch = function(after){
    var searchUsingDefault, ref$, dumpTsv, newNote, stuff, editExisting, editNew;
    searchUsingDefault = require('searchy').searchUsingDefault;
    ref$ = require('./entries'), dumpTsv = ref$.dumpTsv, newNote = ref$.newNote;
    stuff = dumpTsv().split("\n");
    ...
    return searchUsingDefault(stuff, editExisting, editNew);
  };
