...
(function(){
  var ref$, memoize, normalizeDate, localIsoTime, yaml, deltosHome, BASEDIR, getFilename, tagged, fs, uuid, filter, values, sortBy, reverse, newNote, dumpTodos, dumpTsv, dumpTsvTagged, dumpTsvCore, grepEntries, readEntry, readEntryFromFile, getAllEntries, getNewId, newDaily, out$ = typeof exports != 'undefined' && exports || this;
