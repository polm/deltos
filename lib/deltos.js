...
(function(){
  var ref$, readStdinAsLinesThen, launchEditor, deltosHome, getFilename, fs, init, newNote, newDaily, dumpTsv, dumpTsvTagged, dumpTodos, writeDaily, writePost, editPost, render, buildSite, buildPrivateReference, dumpJson, commands, addCommand, func, e;
  ...
  ref$ = require('./entries'), newNote = ref$.newNote, newDaily = ref$.newDaily, dumpTsv = ref$.dumpTsv, dumpTsvTagged = ref$.dumpTsvTagged, dumpTodos = ref$.dumpTodos;
  writeDaily = function(){
  ...
  addCommand('tagged', "Dump TSV for posts with tag", function(){
    return console.log(dumpTsvTagged(process.argv[3]));
  });
