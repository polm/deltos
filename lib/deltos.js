...
(function(){
  var ref$, readStdinAsLinesThen, launchEditor, deltosHome, getFilename, readConfig, editConfig, fs, init, config, newNote, newDaily, dumpTsv, dumpTsvTagged, dumpTodos, grepEntries, writeDaily, writePost, editPost, render, buildSite, buildPrivateReference, dumpJson, commands, addCommand, func, e, slice$ = [].slice;
  ref$ = require('./util'), readStdinAsLinesThen = ref$.readStdinAsLinesThen, launchEditor = ref$.launchEditor, deltosHome = ref$.deltosHome, getFilename = ref$.getFilename, readConfig = ref$.readConfig, editConfig = ref$.editConfig;
  fs = require('fs');
  init = function(){
    var mkdirp;
