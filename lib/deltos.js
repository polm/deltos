...
(function(){
  var ref$, launchEditor, deltosHome, getFilename, readConfig, editConfig, fs, init, config, newNote, newDaily, dumpTsv, dumpTsvTagged, dumpTodos, grepEntries, philtreEntries, writeDaily, writePost, editPost, render, buildSite, buildPrivateReference, dumpJson, commands, addCommand, func, e, slice$ = [].slice;
  ...
  addCommand("title", "Show title of current Deltos", function(){
    return console.log(config.title);
  });
  ...
  addCommand("philtre [pattern]", "Philtre deltos documents", function(query){
