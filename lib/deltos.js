...
(function(){
  var ref$, Obj, filter, keys, values, groupBy, concat, unique, map, take, sortBy, sortWith, reverse, intersection, readStdinAsLinesThen, launchEditor, deltosHome, BASEDIR, getFilename, init, newNote, dumpTsv, dumpTodos, writeDaily, writePost, editPost, render, buildSite, buildPrivateReference, allToJson, commands, addCommand, func, e;
  ...
  ref$ = require('./util'), readStdinAsLinesThen = ref$.readStdinAsLinesThen, launchEditor = ref$.launchEditor;
  ...
  ref$ = require('./entries'), newNote = ref$.newNote, dumpTsv = ref$.dumpTsv, dumpTodos = ref$.dumpTodos;
  writeDaily = function(){
