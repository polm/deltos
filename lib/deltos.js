...
(function(){
  var ref$, Obj, filter, keys, values, groupBy, concat, unique, map, take, sortBy, sortWith, reverse, intersection, readStdinAsLinesThen, launchEditor, deltosHome, getFilename, init, newNote, dumpTsv, dumpTodos, writeDaily, writePost, editPost, render, buildSite, buildPrivateReference, allToJson, commands, addCommand, func, e;
