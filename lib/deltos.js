...
(function(){
  var ref$, launchEditor, deltosHome, getFilename, readConfig, editConfig, installTheme, addImage, regenerateImages, fs, init, newNote, newDaily, dumpTsv, dumpTsvTagged, dumpTodos, grepEntries, philtreEntries, writeDaily, writePost, editPost, render, buildSite, buildPrivateReference, dumpJson, commands, addCommand, func, e, slice$ = [].slice;
  ...
  ref$ = require('./image'), addImage = ref$.addImage, regenerateImages = ref$.regenerateImages;
  fs = require('fs');
  ...
  addCommand('clean', "Delete built HTML etc.", function(){
    var dirs, i$, len$, dir, lresult$, j$, ref$, len1$, fname, results$ = [];
  ...
  addCommand('add-image', "Add an image to the store", addImage);
  addCommand('regenerate-images', "Destroy and regenerate resized images.", regenerateImages);
