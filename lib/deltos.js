...
(function(){
  var ref$, readStdinAsLinesThen, launchEditor, deltosHome, getFilename, fs, init, newNote, newDaily, dumpTsv, dumpTodos, writeDaily, writePost, editPost, render, buildSite, buildPrivateReference, dumpJson, commands, addCommand, func, e;
