...
(function(){
  var fs, yaml, markdown, ref$, Obj, filter, keys, values, groupBy, concat, unique, map, take, sortBy, sortWith, reverse, intersection, uuid, ls, domino, RSS, eep, Section, memoize, deltosHome, BASEDIR, getFilename, evalLs, isIn, tagged, init, readConfig, writePost, editPost, normalizeDate, readEntry, readEntryFromFile, getAllEntries, localIsoTime, newNote, noEmpty, readStdinAsLinesThen, launchEditor, dumpTsv, htmlInit, beginsWith, readEntryBody, getTemplate, buildPage, entryRules, deltosLinkToHtml, getRenderedEntries, render, renderMultiple, toMarkdownLink, buildListPage, sortOrderThenDate, buildHierarchicalList, buildSite, allToJson, commands, addCommand, func, e;
  fs = require('fs');
