...
(function(){
  var ref$, launchEditor, deltosHome, getFilename, readConfig, editConfig, installTheme, readEntry, newNote, dumpTsv, dumpTsvTagged, dumpTodos, grepEntries, philtreEntries, dbInit, dbUpdate, dbDump, getThreadNext, getThreadPrev, getThreadLatest, commands, addCommand, func, e;
  ...
  ref$ = require('./entries'), readEntry = ref$.readEntry, newNote = ref$.newNote, dumpTsv = ref$.dumpTsv, dumpTsvTagged = ref$.dumpTsvTagged, dumpTodos = ref$.dumpTodos, grepEntries = ref$.grepEntries, philtreEntries = ref$.philtreEntries;
  ref$ = require('./db'), dbInit = ref$.dbInit, dbUpdate = ref$.dbUpdate, dbDump = ref$.dbDump, getThreadNext = ref$.getThreadNext, getThreadPrev = ref$.getThreadPrev, getThreadLatest = ref$.getThreadLatest;
  ...
  addCommand('tagged', "Dump TSV for posts with tag", dumpTsvTagged);
  ...
  addCommand('get-thread-next', "Get next post in thread, if any", function(id){
    return console.log(getThreadNext(id));
  });
  addCommand('get-thread-prev', "Get previous post in thread, if any", function(id){
    return console.log(getThreadPrev(id));
  });
  addCommand('get-thread-latest', "Get latest post in thread", function(name){
    return console.log(getThreadLatest(name));
  });
  try {
